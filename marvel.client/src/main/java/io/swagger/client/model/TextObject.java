...
public class TextObject {
   ...
   * @return type
  **/
  @Schema(description = "The canonical type of the text object (e.g. solicit text, preview text, etc.).")
   ...
   * @return language
  **/
  @Schema(description = "The IETF language tag denoting the language the text object is written in.")
